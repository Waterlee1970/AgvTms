...
interface AppState {
  ...
  // Conveyor Tasks (三种类型：agv_only / conveyor_only / mixed)
  conveyorTasks: ConveyorTask[];
  setConveyorTasks: (tasks: ConveyorTask[]) => void;
...
export const useStore = create<AppState>((set) => ({
  ...
  conveyorTasks: [],
  setConveyorTasks: (conveyorTasks) => set({ conveyorTasks }),
