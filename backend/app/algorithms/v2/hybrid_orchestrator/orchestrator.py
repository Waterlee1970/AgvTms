    ...
    def operational_plan(
        ...
        for agv_id, task_ids in agv_assignments.items():
            ...
            if use_sipp and self._sipp:
                ...
                result = self._astar.find_path(start_node, goal)
